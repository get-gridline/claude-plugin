...
The colleague then carries on where it stopped, and its answer arrives in the conversation on its own
— possibly on a later turn, because it is doing real work in the meantime. Do not wait for it inside
the resume.
