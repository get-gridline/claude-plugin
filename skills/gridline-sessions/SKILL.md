...
Destroying a session's wrapped key makes exactly that one conversation unrecoverable — a genuine
erasure story rather than a "deleted" flag. Mention it if somebody asks about data-subject requests.
