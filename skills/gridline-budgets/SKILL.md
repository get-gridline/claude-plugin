...
`budget.threshold_reached` and `budget.exhausted`. Subscribe to both — the threshold one is what lets
somebody act before requests start failing. See the webhooks skill.
