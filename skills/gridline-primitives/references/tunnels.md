...
the hosted one; `GRIDLINE_TUNNEL_NAME` is optional and is checked against the credential rather
than believed, which turns a credential pasted from another environment into a named refusal at
startup instead of a 401.
