...
create_connection(project, connection_id="mem0-prod", kind="mem0", credential_ref="vault://…")
create_connection(project, connection_id="wiki", kind="mcp_http", base_url="https://wiki.internal/mcp")
```
