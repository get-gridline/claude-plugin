...
Set on every response through the proxy. These are how you tell what actually happened, and each
exists because its absence was once mistaken for something else.
