...
harnesses:
  standard:
    ...
    tools:
      - connection: erp
        tools: [{name: erp_create_bill, description: "…", parameters: "…"}]
    permissions:
      default: allow
...
agents:
  globex_chat:
    name: Chat
    system_prompt_file: ./prompts/globex_chat.md
    harness: standard
    model: {provider: anthropic, model: claude-sonnet-4-5}
    fallbacks:
      - {provider: bedrock, model: claude-sonnet-4-5}   # same model, a host that actually offers it
