...
`GRIDLINE_TUNNEL_NAME` is optional and is *checked* against the credential rather than believed —
worth suggesting, because it turns a credential pasted from another environment into a named
refusal at startup instead of a 401 that reads as a revoked key.
